...
namespace ObjectDectection
{
	public class Program
	{
		static void Main(string[] args)
		{
			var assetsRelativePath = @"../../../../Data/assets";
		...
		{
			Image image = Image.FromFile(filename: Path.Combine(inputImageLocation, imageName));
